...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://bokepbugilbocil.pages.dev/v/${file.filecode}#${file.title}`,
